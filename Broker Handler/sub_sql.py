...
def on_message(mqttc, obj, msg):
	try:
		...
		print "outside temp"	
		outside_temp = data['OutTemp']
		print outside_temp
		
		print "indoor temp"
		indoor_temp = data['InTemp']
		print indoor_temp
		...
		print thedate
		sqldata = 'INSERT INTO %s VALUES(%s,%s,%s,%s,%s,%s,%s)' % (target_table, environment, humidity, indoor_temp, outside_temp,soil_moisture, thedate, sensor_id)
		print sqldata
		try:
			cur.execute(sqldata)
			con.commit()
