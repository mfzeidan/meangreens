...
//echo $row['deviceID'];
	...
	$email = $_POST['email'];
        ...
        $query = "update `device_mgmt` set desired_temp = $temp where deviceID = '$devID' and username = '$sesh' ";
	//echo $query;
...
?>
	...
	<p>Please enter your new desired temperature for device <b><?php echo $devID; ?></b> </p>
