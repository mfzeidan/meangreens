...
<br>
	...
	<div class="container">
  <h1>Device Info</h1>
<i class="ionicons ion-thermometer"></i>

	<div class="pull-left">
	<h4><b><?php echo $email_row['email']?> </b>
				
	<a href="email_update.php" data-toggle="popover" data-trigger="hover" data-content="Click to Change your Email Here" class="glyphicon glyphicon-envelope"><right></right></a></span>
		</span></a>
...
<br><br>
		...
		<center>Warning Temperature 
			...
			<a href="device_update3.php" data-toggle="popover" data-trigger="hover" data-content="Change your Devices Temperature" class="glyphicon glyphicon-fire"></a>
...
?>
		...
		<h4> <b>Add/Remove a device!</h4>
              <a href="registerdevice.php" class="btn btn-success">
...
const ticks = 6
        ...
        var loadData = function (data) {
            ...
            console.log("modal "+ modal.offsetWidth + " width " + width);
            
            svg.selectAll("g").remove();
            svg.selectAll("width").remove();
