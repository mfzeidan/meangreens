...
def on_message(mqttc, obj, msg):
	...
	print "outside temp"	
	outside_temp = data['OutdoorTemp']
	print outside_temp
	
	print "indoor temp"
	indoor_temp = data['IndoorTemp']
	print indoor_temp
	...
	print "TargetTable"
	#target_table = data['TD']
	target_table = 'hydro_info_8'
	print target_table
	...
	#print thedate
	sqldata = 'INSERT INTO %s VALUES(%s,%s,%s,%s,%s,%s,%s)' % (target_table, environment, humidity, indoor_temp, outside_temp,soil_moisture, datetime_val, sensor_id)
	print sqldata
	try:
		cur.execute(sqldata)
		con.commit()
